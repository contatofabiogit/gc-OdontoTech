...
?>
    ...
    <body>
        <div class="container">
            <br>
            <div class="cabecalho">
                <div class="cabecalhoH">Sistema Odontológico - Home</div>
            ...
            <div class="row menus row-centered">
                <div class="col-md-3 text-center col-centered">
                    <a href="#"><img src="images/cadastrar-render.png" class="cadastrar" alt="cadastrar"></a>
                </div>
            ...
            <br>
            <div class="logoCanto row-centered">
            ...
            <div class="rodape text-center">
                © Copyright 2016-2020 <a href="#">OdontoTech</a> - Versão 1.0.0.0
            </div>
        </div>
    </body>
