                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="modal-container">
                                        <div class="row row-centered">
                                            <div class="col-md-4 col-centered text-center dentista">
                                                <a href="buscar-dentista.php" class="hvr-shutter-out-horizontal cadastrar"> <img src="images/buscar-dentista-render.png" class="buscar" alt="buscar" onmouseover="this.src='images//buscar-dentista-render-onmouse.png'" onmouseout="this.src='images/buscar-dentista-render.png'"> </a>
                                            </div>
                                            <div class="col-md-4 col-centered text-center paciente">
